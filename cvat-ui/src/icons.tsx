...
import SVGPreviousLabelIcon from './assets/previous-label-icon.svg';
...
import SVGNextLabelIcon from './assets/next-label-icon.svg';
...
export const PreviousLabelIcon = React.memo((): JSX.Element => <SVGPreviousLabelIcon />);
...
export const NextLabelIcon = React.memo((): JSX.Element => <SVGNextLabelIcon />);
