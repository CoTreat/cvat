...
# input: {
#     "scope": <"send:events","dump:events","view:job_history","view:assignment_notifications","download:exported_file"> or null,
#     "auth": {
#         "user": {
#             "id": <num>,
...
allow if {
    input.scope == utils.VIEW_ASSIGNMENT_NOTIFICATIONS
    utils.is_sandbox
    utils.has_perm(utils.WORKER)
}
